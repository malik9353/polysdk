...
class ReclaimFunds extends Procedure_1.Procedure {
    constructor() {
        super(...arguments);
        this.type = types_1.ProcedureType.ReclaimFunds;
    }
    prepareTransactions() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.addTransaction(dividendModule.reclaimDividend, {
                tag: types_1.PolyTransactionTag.ReclaimDividendFunds,
