...
class EnableGeneralPermissionManager extends Procedure_1.Procedure {
    constructor() {
        super(...arguments);
        this.type = types_1.ProcedureType.EnableGeneralPermissionManager;
    }
    prepareTransactions() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const moduleName = contract_wrappers_1.ModuleName.GeneralPermissionManager;
            ...
            yield this.addTransaction(securityToken.addModuleWithLabel, {
                tag: types_1.PolyTransactionTag.EnableGeneralPermissionManager,
            })({
                moduleName,
...
exports.EnableGeneralPermissionManager = EnableGeneralPermissionManager;
//# sourceMappingURL=EnableGeneralPermissionManager.js.map