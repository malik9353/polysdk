...
class Erc20DividendsManagerFactory extends Factory_1.Factory {
    constructor(context) {
        super(Erc20DividendsManager_1.Erc20DividendsManager, context);
        this.generateProperties = (uid) => __awaiter(this, void 0, void 0, function* () {
            const { securityTokenId } = Erc20DividendsManager_1.Erc20DividendsManager.unserialize(uid);
            const { symbol } = SecurityToken_1.SecurityToken.unserialize(securityTokenId);
            const [dividendsModule] = yield this.context.contractWrappers.getAttachedModules({ symbol, moduleName: contract_wrappers_1.ModuleName.ERC20DividendCheckpoint }, { unarchived: true });
            if (!dividendsModule) {
...
exports.Erc20DividendsManagerFactory = Erc20DividendsManagerFactory;
//# sourceMappingURL=Erc20DividendsManagerFactory.js.map